...
local M = {
	...
	{ "nvim-telescope/telescope-ui-select.nvim", lazy = false, priority = 1000 },
	{
		...
		keys = {
			{
				map.CMD_p,
				"<cmd>lua require'telescope.builtin'.find_files(require('telescope.themes').get_dropdown({ previewer = false, find_command = rg }))<cr>",
				desc = "Open File",
			},
			{
				map.CMD_SHIFT_P,
